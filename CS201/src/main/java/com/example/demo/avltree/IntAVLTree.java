...
public class IntAVLTree  implements Serializable {
    ...
    private IntNode rotateWithLeftChild(IntNode node2)
    {
        IntNode node1 = node2.leftChild;
    ...
    private IntNode rotateWithRightChild(IntNode node1)
    {
        IntNode node2 = node1.rightChild;
    ...
    private IntNode doubleWithLeftChild(IntNode node3)
    {
    ...
    private IntNode doubleWithRightChild(IntNode node1)
    {
    ...
    private int getTotalNumberOfNodes(IntNode head)
    {
        if (head == null)
            return 0;
        else
    ...
    private boolean searchElement(IntNode head, int element)
    {
        boolean check = false;
    ...
    private void inorderTraversal(IntNode head)
    {
        if (head != null)
        {
    ...
    private void preorderTraversal(IntNode head)
    {
        if (head != null)
        {
            System.out.print(head.element+" ");
    ...
    private void postorderTraversal(IntNode head)
    {
        if (head != null)
        {
